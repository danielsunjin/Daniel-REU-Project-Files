...
ggplot(data = day0_APOE22_age_sex_treatment, aes(x = Time, y = len, color = Age)) +
  ...
  theme_bw() + 
  labs(title = 'Day 0 Learning Curves for APOE22 Mice by Treatment, Sex, and Age', x = 'Sound Component (92 Seconds Apart)', y = 'Mean Percent Time Freezing (Seconds)') +
...
day1_APOE22_relevant_data %>% 
  ...
  labs(title='Day 1 Contextual Test for APOE22 Mice by Treatment, Sex, and Age', y = 'Percent Freezing Time (Seconds)', x='Age')
...
pretone %>% 
  ...
  geom_point(position=position_jitterdodge(), aes(color = Sex)) +
  #geom_jitter(height = 0, width = 0.2, aes(group = Sex, color = Sex)) +
  labs(title='Day 2 Pre-Tone Data for APOE22 Mice by Treatment, Sex, and Age', y = 'Percent Freezing Time (Seconds)', x='Age')
...
tone %>% 
  ...
  geom_point(position=position_jitterdodge(), aes(color = Sex)) +
  #geom_jitter(height = 0, width = 0.2, aes(group = Sex, color = Sex)) +
  labs(title='Day 2 Tone Data for APOE22 Mice by Treatment, Sex, and Age', y = 'Percent Freezing Time (Seconds)', x='Age')
...
posttone %>% 
  ...
  geom_point(position=position_jitterdodge(), aes(color = Sex)) +
  #geom_jitter(height = 0, width = 0.2, aes(group = Sex, color = Sex)) +
  labs(title='Day 2 Post-Tone Data for APOE22 Mice by Treatment, Sex, and Age', y = 'Percent Freezing Time (Seconds)', x='Age')
