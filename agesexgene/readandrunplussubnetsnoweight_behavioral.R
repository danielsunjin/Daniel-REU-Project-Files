...
png("/Users/daniel/Downloads/short2dnet2.png", units="in", width=10, height=10, res=400)  
...
title(main = "Networks Correlated with Behavioral Data")
dev.off()
...
Sex=response$Sex; Sex[Sex=="male"]="1M"; Sex[Sex=="female"]="2F"; 
